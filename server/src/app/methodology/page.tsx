...
const SECTIONS = [
  ...
  { id: "price-clv", label: "Price-based CLV" },
  { id: "consensus", label: "The closing average" },
  { id: "ev", label: "Expected value (EV%)" },
  { id: "book-favorability", label: "Book favourability" },
  { id: "beat-rate", label: "Beat rate and sample" },
  { id: "grading", label: "Grading" },
  { id: "push", label: "Pushes" },
  { id: "void", label: "Voids" },
  { id: "break-even", label: "Hit rate vs. break-even" },
  { id: "ungradeable", label: "What can't be graded" },
  { id: "manual-grade", label: "Manual grades" },
  { id: "clv-vs-result", label: "CLV vs. hitting" },
  { id: "expectation", label: "Above/below expectation" },
  { id: "odds-links", label: "Links to current odds" },
  { id: "late", label: "Late reads" },
];
    ...
    <main>
      <div className="settings-layout">
        <div className="settings-sidebar">
          ...
          <SettingsNav sections={SECTIONS} ariaLabel="Methodology sections" />
        </div>
